 ...
 * @author duyli
 */
public class PanelCTT extends JPanel {
    ...
    public void initComponents() {
        ...
        btnXuatFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    String path = System.getProperty("user.dir") + "\\src\\GUI\\excel\\BackUpData_ChiTietThue.xlsx";
                    bk.backup_ChiTietThue(path);
        ...
        tbCTT.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    String tinhTrang = tbCTT.getValueAt(tbCTT.getSelectedRow(), tbCTT.getColumnModel().getColumnIndex("Tình trạng xử lý")).toString();
                    if (tinhTrang.equalsIgnoreCase("Chưa xử lý")) {
                        int column = tbCTT.getColumnModel().getColumnIndex("Mã chi tiết thuê");
                        FrameOrderRoom.maCTT = (String) tbCTT.getValueAt(tbCTT.getSelectedRow(), column);
                        try {
                            new FrameOrderRoom();
                        ...
                        HoaDonDTO x = HoaDonBUS.getHoaDon(maCTT);
                        if (x != null) {
                            new ChiTietHoaDon(x.getMaHD(),x.getMaChiTietThue(),x.getNgayThanhToan(),NhanVienBUS.getTenNV(x.getMaNV()),x.getTienPhong()+"",x.getTienDichVu()+"",x.getGiamGia()+"",x.getTongTien()+"");
                        }
                    }
                }
        ...
        btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(PanelCTT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (ParseException ex) {
                    java.util.logging.Logger.getLogger(PanelCTT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                }
