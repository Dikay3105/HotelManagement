...
public class TimeChoose extends JPanel {
    ...
    public TimeChoose() {
        ImageIcon iconUp = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/icons8-up-96.png")).getImage().getScaledInstance(20, 10, Image.SCALE_SMOOTH));
        ImageIcon iconDo = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/icons8-down-96.png")).getImage().getScaledInstance(20, 10, Image.SCALE_SMOOTH));
        pnMinute = new JPanel();
