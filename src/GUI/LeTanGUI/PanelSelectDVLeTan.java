...
public class PanelSelectDVLeTan extends JFrame {
    ...
    public PanelSelectDVLeTan(DatPhongLeTan dp) {
        initComponents(dp);
    }
    ...
    public void initComponents(DatPhongLeTan dp) {
        setSize(700, 600);
